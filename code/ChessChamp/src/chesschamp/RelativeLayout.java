 ...
 */
class RelativeLayout implements LayoutManager2, java.io.Serializable {
  ...
  final static float LEADING = 0.0f;
  final static float CENTER = 0.5f;
  final static float TRAILING = 1.0f;
  final static float COMPONENT = -1.0f;

  //  See setRoundingPolicy() method
  final static int DO_NOTHING = 0;
  final static int FIRST = 1;
  final static int LAST = 2;
  final static int LARGEST = 3;
   ...
   * - extra pixels added to the last relative component LARGEST (default) -
   * extra pixels added to the larger relative component EQUAL - a single pixel
   ...
   * each column in the container, plus the horizontal padding times the number
   * of columns minus one, plus the left and right insets of the target
   * container.
   * <p>
   ...
   * specified container #@see	java.awt.RelativeLayout#minimumLayoutSize
   ...
   * specified container #@see	java.awt.RelativeLayout#preferredLayoutSize
